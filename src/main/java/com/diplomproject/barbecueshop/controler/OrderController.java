...
public class OrderController extends GenericController<Order, OrderDto> {
    ...
    @PostMapping("/apply-order-in-delivery")
     public DeliveryOrder addUserInOrder(@RequestBody ApplyOrderToDeliveryDto applyOrderToDeliveryDto) {
       return deliveryOrderService.applyToDelivery(applyOrderToDeliveryDto);
       }
